...
User::User()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_login_2eproto::scc_info_User.base);
  SharedCtor();
...
const User& User::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_login_2eproto::scc_info_User.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::User* Arena::CreateMaybeMessage< ::User >(Arena* arena) {
